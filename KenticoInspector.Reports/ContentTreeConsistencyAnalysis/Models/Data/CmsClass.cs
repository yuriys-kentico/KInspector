...
namespace KenticoInspector.Reports.ContentTreeConsistencyAnalysis.Models.Data
{
    ...
    {
        private IEnumerable<CmsClassField>? _classFields;
        private string? _classIdColumn;
        ...
        public IEnumerable<CmsClassField>? ClassFields
        {
            get
            {
                if (_classFields == null && ClassFormDefinitionXml != null) _classFields = GetFieldsFromXml();
