  ...
  <v-card>
    <v-card-text>
      <v-form ref="form"
              v-model="valid"
              lazy-validation>
        <v-text-field v-model="instance.databaseSettings.server"
                      :rules="[v => !!v || 'Database server name is required']"
                      label="Database server name"
                      required
                      clearable />

        <v-text-field v-model="instance.databaseSettings.database"
                      :rules="[v => !!v || 'Database name is required']"
                      label="Database name"
                      required
                      clearable />

        <v-switch v-model="instance.databaseSettings.integratedSecurity"
                  label="Integrated Security">
        </v-switch>

        <div v-show="!instance.databaseSettings.integratedSecurity">
          <v-text-field v-model="instance.databaseSettings.user"
                        :rules="[v => {
          ...
          <v-text-field v-model="instance.databaseSettings.password"
                        type="password"
                        label="SQL user password"
                        clearable />
        </div>

        <v-text-field v-model="instance.url"
        ...
        <v-text-field v-model="instance.path"
                      ...
                      required
                      clearable />
        <v-text-field v-model="instance.name"
                      label="Name (optional)"
