    ...
    internal static class MockInstanceDetails
    {
        ...
        internal static InstanceDetails Kentico12 = new InstanceDetails
        {
            ...
            Sites = new List<CmsSite>
            {
                new CmsSite
                {
                    SiteDomainName = "kentico12.com"
                }
            }
        };

        internal static InstanceDetails Get(
            int majorVersion,
            Instance instance
            )
        {
            ...
            if (instanceDetails != null) instanceDetails.Guid = instance.Guid;
